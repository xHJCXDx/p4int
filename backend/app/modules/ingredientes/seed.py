...
def seed_ingredientes(session: Session) -> Dict[str, Ingrediente]:
    ...
    ingredientes_data = [
        ...
        {"nombre": "Tomate", "descripcion": "Tomate fresco", "es_alergeno": False, "stock_cantidad": 150, "unidad_medida_codigo": "kg"},
        ...
        {"nombre": "Cebolla", "descripcion": "Cebolla fresca", "es_alergeno": False, "stock_cantidad": 180, "unidad_medida_codigo": "kg"},
        {"nombre": "Ajo", "descripcion": "Ajo fresco", "es_alergeno": False, "stock_cantidad": 200, "unidad_medida_codigo": "g"},
